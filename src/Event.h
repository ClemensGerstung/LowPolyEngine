  ...
  namespace utils
  {
    ...
    template <typename TSender,
              ...
              typename = typename std::enable_if<std::is_base_of<EventArgs,
                                                                 typename std::decay<TArgs>::type>::value>::type>
    class Event
    {
    public:
      using Callback = std::function<void(const TSender&,
                                          const TArgs&)>;
    private:
    ...
    public:
      ...
      void operator()(const TSender& sender,
      ...
      void Invoke(const TSender& sender,
                  const TArgs& args) const
      {
